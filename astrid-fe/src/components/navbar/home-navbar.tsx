      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex-shrink-0">
            <Link to="/">
              <a className="text-xl font-bold text-gray-900">Astrid</a>
            </Link>
          </div>
          <div className="hidden md:flex space-x-8">
            ...
            <Link to="/api">
              <a className="text-gray-700 hover:text-gray-900">APIs</a>
            </Link>
            <Link to="/data">
              <a className="text-gray-700 hover:text-gray-900">Data Sources</a>
            </Link>
            <Link to="/permissions">
              <a className="text-gray-700 hover:text-gray-900">Permissions</a>
            </Link>
            <Link to="/services">
